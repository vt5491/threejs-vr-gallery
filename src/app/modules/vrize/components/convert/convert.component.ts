...
export class ConvertComponent implements OnInit {
  ...
  commitExample(e: Event) {
    console.log(`ConvertComponent.commitExample: e=${e}`);
    // console.log(`ConvertComponent.vrizePost: entered`);

    // this.examples.get('src/assets/threejs-env/examples/webgl_geometry_cube.html', "David Bowie")
    // .subscribe((rsp) => {
    //   console.log(`subscribe: rsp=${rsp}`);
    // }) ;
    // console.log(`ConvertComponent.vrizeGet: back from get`);
    ...
    ;
    console.log(`ConvertComponent.vrizePost: back from put`);
  }
}
